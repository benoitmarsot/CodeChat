...
public record CreateVSIssueRequest(
    ...
    public CreateVSIssueRequest(String file_id, IssueTrackingPlatforms platform, String channel, String author, String url, boolean isOpen, String timestamp) {
        this(
            file_id,
            createAttributes(platform, channel, author, url, isOpen, timestamp)
        );
    }
    ...
    private static Map<String, String> createAttributes(
        ...
        String url, boolean isOpen, String timestamp
    ) {
